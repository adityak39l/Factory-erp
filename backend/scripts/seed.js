...
const DEMO_EMPLOYEES = [
  { name: 'Parth Agrawal', designation: 'Procurement Manager', department: 'Procurement', type: 'Permanent', shift: 'Day', mobile: '9876500001' },
  { name: 'Ishu Vishwakarma', designation: 'HR Executive', department: 'Human Resources', type: 'Permanent', shift: 'Day', mobile: '9876500002' },
  { name: 'Gaurav Sharma', designation: 'Quality Inspector', department: 'Quality', type: 'Permanent', shift: 'Day', mobile: '9876500003' },
  { name: 'Amresh Singh', designation: 'Marketing Executive', department: 'Marketing', type: 'Permanent', shift: 'Day', mobile: '9876500004' },
  { name: 'Surendra Ahirwar', designation: 'Store Manager', department: 'Store', type: 'Permanent', shift: 'Day', mobile: '9876500005' },
  { name: 'Om Prakash Raikwar', designation: 'Logistics Operator', department: 'Logistics & Final Finishing', type: 'Permanent', shift: 'Day', mobile: '9876500006' },
  { name: 'Sanjay Kushwaha', designation: 'LED Technician', department: 'LED Section', type: 'Permanent', shift: 'Day', mobile: '9876500007' },
  { name: 'Rajpal Singh', designation: 'CNC Tube Operator', department: 'Cutting', type: 'Permanent', shift: 'Day', mobile: '9876500008' },
  { name: 'Uday Kumar', designation: 'CNC Laser Operator', department: 'Cutting', type: 'Permanent', shift: 'Day', mobile: '9876500009' },
  { name: 'Dharmendra Kushwaha', designation: 'Cutting Operator', department: 'Cutting', type: 'Permanent', shift: 'Night', mobile: '9876500010' },
  { name: 'Mohit Yadav', designation: 'Cutting Operator', department: 'Cutting', type: 'Permanent', shift: 'Night', mobile: '9876500011' },
  { name: 'Karan Singh', designation: 'Bending Operator', department: 'Bending', type: 'Permanent', shift: 'Day', mobile: '9876500012' },
  { name: 'Umendra Yadav', designation: 'Bending Helper', department: 'Bending', type: 'Permanent', shift: 'Night', mobile: '9876500013' },
  { name: 'Sandeep Kushwaha', designation: 'Grinder Man', department: 'Grinding', type: 'Permanent', shift: 'Day', mobile: '9876500014' },
  { name: 'Suresh Kumar Jha', designation: 'Welder', department: 'Welding', team: 'Team A', type: 'Permanent', shift: 'Day', mobile: '9876500015' },
  { name: 'Jitendra Kushwaha', designation: 'Welder', department: 'Welding', team: 'Team A', type: 'Permanent', shift: 'Day', mobile: '9876500016' },
  { name: 'Shivam Vishwakarma', designation: 'Welder', department: 'Welding', team: 'Team B', type: 'Permanent', shift: 'Day', mobile: '9876500017' },
  { name: 'Krishna Mohan Gautam', designation: 'Contract Welder', department: 'Welding', team: 'Team C', type: 'Contract', mobile: '9876500018' },
  { name: 'Manish Jha', designation: 'Contract Welder', department: 'Welding', team: 'Team C', type: 'Contract', mobile: '9876500019' },
  { name: 'Nilesh Kumar', designation: 'Contract Grinder', department: 'Grinding', type: 'Contract', mobile: '9876500020' },
  { name: 'Washim Khan', designation: 'Straightening Operator', department: 'Straightening & Threading', type: 'Permanent', shift: 'Day', mobile: '9876500021' },
  { name: 'Ashraf Khan', designation: 'Painter', department: 'Painting', type: 'Permanent', shift: 'Day', mobile: '9876500022' },
  { name: 'Rakesh Kumar', designation: 'Painter', department: 'Painting', type: 'Permanent', shift: 'Night', mobile: '9876500023' },
  { name: 'Abhishek Kushwaha', designation: 'Helper', department: 'Helper', type: 'Permanent', shift: 'Day', mobile: '9876500024' },
  { name: 'Sanjeev Kumar', designation: 'Helper', department: 'Helper', type: 'Permanent', shift: 'Day', mobile: '9876500025' },
  // Support roles: no work description / quantity is ever expected from them.
  { name: 'Anand Kumar', designation: 'Security Guard', department: 'Security & Support', type: 'Permanent', shift: 'Day', requiresWorkQty: false, mobile: '9876500026' },
  { name: 'Anoop Singh', designation: 'Security Guard', department: 'Security & Support', type: 'Permanent', shift: 'Night', requiresWorkQty: false, mobile: '9876500027' },
  { name: 'Pooja Devi', designation: 'Cook', department: 'Security & Support', type: 'Permanent', shift: 'Day', requiresWorkQty: false, mobile: '9876500028' },
];
